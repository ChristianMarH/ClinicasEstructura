!function (a) {
    ...
    function U(b) {
        var d = b.oClasses, e = b.sTableId, f = b.oLanguage, g = b.oPreviousSearch, h = b.aanFeatures, i =
            '<br/><input type="search" class="form-control" />'
            , j = f.sSearch, j = j.match(/_INPUT_/) ? j.replace("_INPUT_", i) : j + i, d = a("<div/>", {
            ...
            }, i = null !== b.searchDelay ? b.searchDelay : "ssp" === Mb(b) ? 400 : 0, k = a("input", d).val(g.sSearch).attr("placeholder", "Buscar").on("keyup.DT search.DT input.DT paste.DT cut.DT", i ? qc(h, i) : h).on("keypress.DT", function (a) {
    ...
    function jb(a, b, c) {
        ...
        0 === f || -1 === e ? d = 0 : "number" === typeof b ? (d = b * e, d > f && (d = 0)) : "Primera" == b ? d = 0 : "Anterior" == b ? (d = 0 <= e ? d - e : 0,
            0 > d && (d = 0)) : "Siguiente" == b ? d + e < f && (d += e) : "Ultima" == b ? d = Math.floor((f - 1) / e) * e : Eb(a, 0, "Unknown paging action: " + b, 5);
    ...
    a.extend(Dc, {
        ...
        full: function () {
            return ["Primera", "Anterior", "Siguiente", "Ultima"];
        },
        numbers: function (a, b) {
            return [Nb(a, b)];
        },
        simple_numbers: function (a, b) {
            return ["Anterior", Nb(a, b), "Siguiente"];
        },
        full_numbers: function (a, b) {
            return ["Primera", "Anterior", Nb(a, b), "Siguiente", "Ultima"];
        },
        first_last_numbers: function (a, b) {
            return ["Primera", Nb(a, b), "Ultima"];
        },
        _numbers: Nb,
        numbers_length: 7
    });
